...
run_params = {
    ...
    "dataset": "moons",  # "moons", "GMM", "cats", "catsdogs", "invkin", "glacgrav"
...
model_arch_params = {
    ...
    "hidden_layers": [128, 128],  # nodes per layer within affine coupling layers
    "flow_steps": 2,  # number of affine coupling layers
    "validate_args": True,
}
